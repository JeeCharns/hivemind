 ...
 *
 * POST - Update account profile (display name and avatar)
 * Accepts multipart/form-data with displayName and optional avatar file
 * Reuses profile API logic for consistency
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await updateAccountProfile(supabase, session.user.id, {
    ...
    console.error("[POST /api/account/profile] Error:", error);
